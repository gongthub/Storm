...
$.currentWindow = function () {
    var iframeId = top.$(".Storm_iframe:visible").attr("id");
...
$.modalShowFull = function (options) {
    var defaults = {
        id: null,
        title: '系统窗口',
        width: "100px",
    ...
    var options = $.extend(defaults, options);
    var _width = top.$(window).width() + 'px';
    var _height = top.$(window).height() + 'px';
    top.layer.open({
        id: options.id,
        type: 2,
        shade: options.shade,
...
$.fn.authorizeButton = function () {
    var moduleId = top.$(".Storm_iframe:visible").attr("id").substr(6);
