(function ($) {
    $.nfinetab = {
        ...
        refreshTab: function () {
            ...
            var target = $('.Storm_iframe[data-id="' + currentId + '"]');
        ...
        activeTab: function () {
            ...
            if (!$(this).hasClass('active')) {
                $('.mainContent .Storm_iframe').each(function () {
                    if ($(this).data('id') == currentId) {
                        $(this).show().siblings('.Storm_iframe').hide();
                        return false;
                    }
                });
        ...
        closeOtherTabs: function () {
            $('.page-tabs-content').children("[data-id]").find('.fa-remove').parents('a').not(".active").each(function () {
                $('.Storm_iframe[data-id="' + $(this).data('id') + '"]').remove();
                $(this).remove();
            });
        ...
        addTab: function () {
            ...
            if (dataId != "") {
                top.$.cookie('Storm_currentmoduleid', dataId, { path: "/" });
            }
            ...
            if (flag) {
                ...
                var str1 = '<iframe class="Storm_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
                $('.mainContent').find('iframe.Storm_iframe').hide();
        ...
        init: function () {
            ...
            $('.tabCloseAll').on('click', function () {
                ...
                $('.page-tabs-content').children("[data-id]:first").each(function () {
                    $('.Storm_iframe[data-id="' + $(this).data('id') + '"]').show();
