...
namespace Storm.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "Storm_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("Storm_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("Storm_licence", Licence.GetLicence());
        }
